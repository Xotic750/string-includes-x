 ...
 */
"use strict";var isWorking,nativeIncludes="function"==typeof String.prototype.includes&&String.prototype.includes;if(nativeIncludes){var attempt=_dereq_("attempt-x"),res=attempt.call("/a/",nativeIncludes,/a/);(isWorking=res.threw)&&(isWorking=!1===(res=attempt.call("abc",nativeIncludes,"a",Infinity)).threw&&!1===res.value),isWorking&&(isWorking=!1===(res=attempt.call(123,nativeIncludes,"2")).threw&&!0===res.value),isWorking&&(isWorking=(res=attempt.call(null,nativeIncludes,"u")).threw)}var $includes;if(isWorking)$includes=function includes(string,searchString){var args=[searchString];return arguments.length>2&&(args[1]=arguments[2]),nativeIncludes.apply(string,args)};else{var isRegExp=_dereq_("is-regexp-x"),toStr=_dereq_("to-string-x"),requireObjectCoercible=_dereq_("require-object-coercible-x"),indexOf=String.prototype.indexOf;$includes=function includes(string,searchString){var str=toStr(requireObjectCoercible(string));if(isRegExp(searchString))throw new TypeError('"includes" does not accept a RegExp');var args=[toStr(searchString)];return arguments.length>2&&(args[1]=arguments[2]),-1!==indexOf.apply(str,args)}}module.exports=$includes},{"attempt-x":4,"is-regexp-x":18,"require-object-coercible-x":30,"to-string-x":40}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":17,"safe-to-string-x":31}],4:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":36,"to-property-key-x":38}],7:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":21,"validate.io-undefined":44}],16:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":14,"to-number-x":35}],24:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":43,"white-space-x":45}],26:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":19}],30:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":15}],31:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":24,"to-integer-x":33}],35:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":30}],37:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":7,"to-primitive-x":37,"to-string-x":40}],39:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":21,"validate.io-undefined":44}],40:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":20}],41:[function(_dereq_,module,exports){/**
